...
from keyboards.inline import music_results_keyboard
from services.cleanup import remove_file
from services.downloader import download_video, search_music
...
async def download_url_handler(message: Message, config: Config, db: Database, state: FSMContext) -> None:
    ...
    if not url:
        ...
        try:
            ...
            await message.answer("<b>Natijalardan birini tanlang:</b>", reply_markup=music_results_keyboard(results, page=0))
